...
The tutorial will focus on the primary components of exploratory data analysis (EDA), including importing, manipulating, visualising, and modelling data. We will be using the [`tidyverse`](https://www.tidyverse.org/) suite of packages, which makes data analysis easy and efficient! 
